      ...
      {(props) => {
        ...
        return (
          <div className="vendors">
            {/* <SEO title="Seller Register" /> */}
            <div className="vendors-left">
              <div className="vendors-top">
                <img src="/assets/new-logo-lights.png" alt="" />

                <h2>Achieve greater visibility with a wider audience</h2>
                <Link to="/">
            ...
            <div id="overflow" className="vendors-right">
              <div className="vendors-form">
                <h1>Become a Seller</h1>
                <small>
                  Fill in the required fields below to become a seller in an
                  instant!
                </small>
